...
class DatabaseTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        // todo: make sure tests are isolated and do not effect other tests
        // todo: is it possible to avoid creating the database table on every test?
        // todo: interract with Table object directly instead of array?
        // todo: maybe perform the updates using one call to update_table?
        // todo: how to cache Doctrine Types?
    ...
    protected function can_rename_column()
    {
        ...
        // todo: maybe also make sure only the name was updated?
    }
